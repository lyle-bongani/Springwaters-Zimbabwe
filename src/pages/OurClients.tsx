...
const OurClients: React.FC = () => {
    return (
        <section id="about-section" className="bg-white pt-32 pb-16 px-4 flex flex-col items-center min-h-[60vh] mt-16">
            <h1 className="text-4xl md:text-5xl font-extrabold text-center mb-4 text-[#4169e1]">Our Clients</h1>
            <p className="text-lg text-[#4169e1] text-center mb-10 max-w-2xl font-medium">We are proud to have partnered with a diverse range of clients across Zimbabwe, delivering reliable water solutions for homes, businesses, and communities.</p>
