...
const OurProcess: React.FC = () => (
    <main className="w-full bg-white min-h-screen overflow-x-hidden">
        {/* Hero Section */}
        <section className="relative w-full bg-gradient-to-br from-[#e3f0ff] to-[#f5f8ff] py-24 px-4 text-center flex flex-col items-center justify-center overflow-hidden">
            {/* Decorative SVG */}
        ...
        <section className="w-full bg-white pt-0 pb-20 px-4 flex flex-col items-center relative overflow-hidden">
        ...
        {/* CTA Section */}
        <section className="relative w-full py-20 px-4 bg-[#4169e1] bg-gradient-to-br from-[#4169e1] to-blue-400 text-white text-center overflow-hidden">
            {/* Decorative SVG */}
